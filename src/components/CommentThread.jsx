      ...
      <div className="comment-thread" id={isNew ? "new-comment" : undefined}>
        <div className="comment-item">
          ...
          <div className="comment-actions-right">
            <div 
              className={`reaction-badge ${comment.reactions?.user_reaction === 'like' ? 'reaction-badge--active' : ''}`}
            ...
            <div 
              className={`reaction-badge ${comment.reactions?.user_reaction === 'dislike' ? 'reaction-badge--active' : ''}`}
            ...
            {comment.replies.map(reply => {
              ...
              return (
                <div key={reply.id} className="reply-thread">
                  ...
                  <div className="comment-actions-right">
                    <div 
                      className={`reaction-badge ${reply.reactions?.user_reaction === 'like' ? 'reaction-badge--active' : ''}`}
                    ...
                    <div 
                      className={`reaction-badge ${reply.reactions?.user_reaction === 'dislike' ? 'reaction-badge--active' : ''}`}
