...
import '@/styles/features/EditIdeaPage.scss'

const EditIdeaPage = () => {
  return (
    <div className="edit-idea-page">
      <MindVaultHeader onBackClick={() => window.history.back()} onDescriptionClick={() => {}} hideSectionTitle={true} />
      ...
      <div className="vault-footer">
        ...
        <input type="text" className="vault-footer__input" placeholder="Добавить идею" />
