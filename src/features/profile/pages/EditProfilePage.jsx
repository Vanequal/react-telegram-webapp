...
import '@/styles/features/EditProfile.scss'

import avatarEditProfile from '@/assets/images/avatarEditProfile.png'

const EditProfilePage = () => {
  return (
    <div className="edit-profile">
      <MindVaultHeader onBackClick={() => window.history.back()} hideSectionTitle hideDescription title="Редактировать профиль" bgColor="#EAEFF6" textColor="black" fontSize="16px" />
