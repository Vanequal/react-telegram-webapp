    ...
    <>
      <div className="publication-card" ref={cardRef}>
        <div className="publication-card__header">
          ...
          <span className="publication-card__username">{publication.author?.username || publication.username || 'Аноним'}</span>
        </div>
          ...
          <div className="publication-card__file-wrapper">
            <div className="file-row">
              ...
              <div className="file-info">
                ...
                <span className="file-size">{firstFile.size ? `${Math.round(firstFile.size / 1024)} Кб` : '73.7 Кб'}</span>
        ...
        <p className="publication-card__excerpt-text">{publication.excerpt || publication.text || 'Нет выдержки'}</p>
        ...
        {/* Footer */}
        <div className="publication-card__footer" onClick={handleCardExpand} style={{ cursor: 'pointer' }}>
          {/* Показываем avatar stack только если есть комментарии */}
          {displayCommentCount > 0 && <img src={avatarStack} alt="Avatars" className="publication-card__avatar-stack" />}
          <span className="publication-card__comments">{displayCommentCount > 0 ? `${displayCommentCount} комментариев` : 'Комментировать'}</span>
