      ...
      <div className="idea-card question-card" ref={cardRef}>
        ...
        <div className="idea-card__top">
          <div className="idea-card__user">
            ...
            <span className="idea-card__username">{question.author?.username || question.username || 'Аноним'}</span>
          </div>
        </div>
        ...
        {questionFiles?.length > 0 && (
          <div className="idea-card__files">
            <FileAttachments files={questionFiles} onImageClick={handleImageClick} />
          </div>
        )}
        ...
        <div className="idea-card__actions-container">
          ...
          <span className="idea-card__timestamp">{formatTimestamp(question.created_at || question.timestamp)}</span>
        </div>
        ...
        <div className="idea-card__footer" onClick={handleCardExpand} style={{ cursor: 'pointer' }}>
          ...
          {displayAnswerCount > 0 && <img src={avatarStack} alt="Avatars" className="idea-card__avatar-stack" />}
          <span className="idea-card__comments">{displayAnswerCount > 0 ? `${displayAnswerCount} ответов` : 'Ответить на вопрос'}</span>
