  ...
  return (
    <>
      ...
      <div className="discussion-footer">
        <img src={skrepkaIcon} alt="Attach" className="discussion-footer__icon" onClick={handleAttachClick} style={{ cursor: 'pointer' }} />

        <input ref={inputRef} type="text" className="discussion-footer__input" placeholder="Комментировать" value={commentText} onChange={handleChange} disabled={isSubmitting} onKeyPress={handleKeyPress} />
