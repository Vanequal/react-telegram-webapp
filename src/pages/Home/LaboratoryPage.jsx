...
const LaboratoryPage = () => {
  ...
  return (
    <div className="laboratory-page">
      ...
      <div className="laboratory-page__top-text">В [Заголовок раздела] ещё нет опубликованных экспериментов.</div>

      <div className="laboratory-page__bottom-text">Придумайте название эксперимента и сформулируйте его сценарий</div>
