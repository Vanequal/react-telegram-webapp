...
import '@/styles/shared/components/HistoryPage.scss'
...
import historyUser from '@/assets/images/historyUser.png'
...
const HistoryPage = () => {
  ...
  return (
    <div className="history-page">
      <MindVaultHeader hideDescription hideSectionTitle onBackClick={() => navigate('/')} title="История" textColor="black" bgColor={'#EEEFF1'} />
      <div className="history-page__content">
        <h2 className="history-page__title">История</h2>

        <div className="history-page__section">
          <a href="#" className="history-page__section-link">
            Конный двор
          </a>
        </div>
