  ...
  return (
    <div className="home">
      ...
      <div className="homebuttons">
        <button
          className={`homebutton homebutton--primary ${animate ? 'animate' : ''}`}
          onClick={handleClick}>
          Обмен &nbsp; опытом
        </button>
        <button className="homebutton homebutton--secondary">
          Описание
        </button>
        <button className="homebutton homebutton--tertiary">
          Идеальный результат
        </button>
        <button className="homebutton homebutton--quaternary">
          Модули проекта
        </button>
      </div>
